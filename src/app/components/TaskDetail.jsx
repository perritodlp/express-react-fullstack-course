...
const TaskDetail = ({
    ...
    <div className="card p-3 col-6">
        ...
        <div className="mt-3">
            <select onChange={setTaskGroup} value={task.groups} className="form-control">
                {groups.map(group=>(
...
export const ConnectedTaskDetail = connect(mapStateProps, mapDispatchToProps)(TaskDetail);